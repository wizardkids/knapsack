...
def cli(message: str, file: str, decrypt: str, keys: str, generate: str) -> None:
    ...
    Using their private key, the sender can encrypt text intended for a specific recipient, meaning that the sender must have the recipient's public key. The encrypted text can only be decrypted by the recipient using the recipient's private key. Keys can be generated by this program using the --generate option.
